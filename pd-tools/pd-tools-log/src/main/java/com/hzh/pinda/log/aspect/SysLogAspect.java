package com.hzh.pinda.log.aspect;
...
import com.hzh.pinda.log.event.SysLogEvent;
import com.hzh.pinda.log.util.LogUtil;
...
public class SysLogAspect {
     ...
     */
    @Pointcut("@annotation(com.hzh.pinda.log.annotation.SysLog)")
